...
public class TrueTables {

	public static void main(String[] args) 
	{
		// TODO Auto-generated method stub
		Scanner keyboard = new Scanner(System.in);
        System.out.println("ESTE PROGRAMA CREA UNA TABLA DE LA VERDAD PARA UNA EXPRESIÓN LÓGICA QUE CONTIENE" +
                "\nLETRAS MINÚSCULAS PARA OPERADORES LÓGICOS Y PREPOSICIONES.");
        System.out.println("LOS OPERADORES SON: " +
                "\n~ = NOT\n^ = AND\nV = OR\n=> = IMPLICA\n<-> = BOCONDICIONAL (SI)");
